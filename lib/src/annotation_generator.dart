  ...
  FutureOr<String> generateForAnnotatedElement(
    ...
    if (isEncrypted) {
      ...
      if (encryptionKey == null || initializationVector == null) {
        key = AESCBCEncrypter.generateRandomBytes(32);
        iv = AESCBCEncrypter.generateRandomBytes(16);
      ...
      for (final field in fields) {
        ...
        final encrypted = base64.encode(
          AESCBCEncrypter.aesCbcEncrypt(key, iv, value.toString()),
        );
      ...
      final tGet = """
        T _get<T>(
          ...
          final decrypted = AESCBCEncrypter.aesCbcDecrypt(encryptionKey, iv, _encryptedValues);
